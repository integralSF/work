...
parser.add_argument('--netG', default='Trained_Model/point_netG400.pth', help="path to netG (to continue training)")
...
test_dset = own_loader.my_LoadData(path='/home/zjh/workspace/PFNet/dataset/own_dataset_processed',prefix="train")
...
#    if a!=b:
        ...
        np.savetxt('test_example_ours/crop_txt'+str(n)+'.txt', np_crop, fmt = "%f,%f,%f")
        np.savetxt('test_example_ours/fake_txt'+str(n)+'.txt', np_fake, fmt = "%f,%f,%f")
        np.savetxt('test_example_ours/real_txt'+str(n)+'.txt', np_real, fmt = "%f,%f,%f")    
